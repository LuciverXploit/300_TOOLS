...
echo -b "TYPE      : LUCI TOOLS $green " |lolcat
echo -b "VERSION   : V.3 " | lolcat
echo -b "TOTALS    : 311 TOOLS " | lolcat
echo -b "AUTHOR    : LUCIVERXPLOIT $green " |lolcat
echo -b "ASSOCIATE : INDONESIAN RAL ASSOCIATION $green " |lolcat
echo -b "ASSOCIATE : INDONESIAN RAL TUTORIAL $green " |lolcat
echo -b "ASSOCIATE : INDONESIAN DARK RAL ASSOCIATE $green " |lolcat
...
sleep 1
echo -b $green"[#]> LUCIVERXPLOIT On Your System" |lolcat
...
00) echo "AUTHOR: LUCIVERXPLOIT" | lolcat
echo "LUCIVERXPLOIT ON YOUR SYSTEM" | lolcat
echo "INDONESIAN RAL ASSOCIATION" | lolcat
